...
<div class="content">
    ...
    <br>
    <form name="mySalOverview" action="searchMySalaries" method="POST" onsubmit="return validateMyForm()">
        <%
    ...
    <div class="selection">
        <table class="searchSal">
            <tr>
                ...
                <th >
                    ...
                    <br><lable id="lblGrSal" class="valLabel"></lable>
                </th>
            </tr>
            <tr>
                <td>
                ...
                <th >
                    ...
                    <br><lable id="lblLeSal" class="valLabel"></lable>
                </th>
            </tr>
        </table>
        <%
        ...
        <table>
            <tr>
                ...
                <th>
                    <div class="year">
                        <input type="number" id="fromYear" name="fromYear" min="2020" value="<%=currentYear%>">
                    </div>
                ...
                <th>
                    ...
                    <!--<br><lable id="lblFromDate" class="valLabel"></lable>-->
                </th>
            ...
            <tr>
                ...
                <th></th>
                <th><lable id="lblFromDate" class="valLabel"></lable></th>
            </tr>
            <tr>
                <td>
                ...
                <th>
                    ...
                    <!--<br><lable id="lblToDate" class="valLabel"></lable>-->
                </th>
            </tr>
            <tr>
                <td>
                ...
                <th></th>
                <th><lable id="lblToDate" class="valLabel"></lable></th>
            </tr>
            <tr>
                <td>
...
<script type="text/javascript" src="js/salaryOverview.js"></script>
</body>
</html>
