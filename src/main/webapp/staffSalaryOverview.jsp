...
<div class="content">
    ...
    <br>
    <form name="staffSalOverview" action="searchStaffSalaries" method="POST" onsubmit="return validateStaffForm()">
        ...
        <div class="selection">
            <table class="searchSal">
                <tr>
                    ...
                    <th >
                        <input  type="number" id="empId" name="empId" min="10000" placeholder="Employee ID">
                    </th>
                </tr>
                <tr>
                    <td>
            ...
            <table>
                <tr>
                    ...
                    <th>
                        <div class="year">
                            <input type="number" id="fromYear" name="fromYear" min="2020" value="<%=year-1%>">
                        </div>
