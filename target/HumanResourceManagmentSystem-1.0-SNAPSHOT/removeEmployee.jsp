...
<div class="content">
    ...
    <form name="delEmp" action="removeEmployee" method="POST" onsubmit="return validateForm2()">
        <%
        ...
        <h4 class="response" style="color: #DC143C;">
            Unable To Remove! This Employee Has Pending Leaves to An Action,Try Again Later.
        </h4><%
